...
const { execute } = require("../lib/Error");
...
module.exports = {
  ...
  async execute(message) {
    ...
    const commandData = commands.find((c) => c.name.toLowerCase() === command.toLowerCase() || (c.aliases && typeof c.aliases === "object" ? c.aliases.includes(command.toLowerCase()) : c.aliases === command.toLowerCase()));
